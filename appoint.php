...
if(isset($_POST['submit']))
{
	...
	$q=mysql_query("insert into appointment(veh_no,reg_no,date,time,status)values('$num','$regno','$date','$time','0')");
	...
	<div class="wrap-container zerogrid">
		<div class="crumbs">
			<ul>
                ...
                <li><a href="viewcase.php">Cases</a></li>
		...
		<div id="main-content">
            ...
            <br>
            <br>
				<center><h2>BOOK APPOINTMENT</h2></center><br>
                <br>
                <br>
                ...
                <tr><td>ADV Reg no</td><td><input type="text" name="reg_no" style="border:1px solid rgba(0,0,0,1.00);" id="reg_no" value="<?php echo $id1 ?>" readonly></td></tr>
                <tr><td>Appointment date</td><td><input type="date" name="date"  style="border:1px solid rgba(0,0,0,1.00);" id="date"></td></tr> 
                <tr><td>Appointment time</td><td><input type="time" name="time"  style="border:1px solid rgba(0,0,0,1.00);" id="time"></td></tr>                               
                <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
