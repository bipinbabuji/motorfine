...
session_start();
$user1=$_SESSION['user'];
$q=mysql_query("select * from messages where veh_no='$user1' and status='1'");
$r=mysql_query("select * from appointment where veh_no='$user1' and status='1'");
$t=mysql_query("select * from appointment where veh_no='$user1' and status='2'");
$a=mysql_num_rows($t);
$s=mysql_query("select * from requests where veh_no='$user1' and status='1'");
$u=mysql_query("select * from requests where veh_no='$user1' and status='2'");
$b=mysql_num_rows($u);
?>
<!DOCTYPE html>
...
<div class="wrap-body">
    ...
    <nav class="cmn-tile-nav">
		<ul class="clearfix">
            ...
            <li class="colour-2"><a href="userhome.php">Home</a></li>
			<li class="colour-3"><a href="viewcase.php">Cases</a></li>
			<li class="colour-4"><a href="request.php">Change requests</a></li>
			<li class="colour-5"><a href="usernotif.php">Notifications</a></li>
            <li class="colour-6"><a href="send_feed.php">Feedback</a></li>
			<li class="colour-7"><a href="index.php">Logout</a></li>
	...
	<div class="wrap-container zerogrid">
		...
		<div id="main-content">
			<div class="wrap-content">
				<center><h2>NOTIFICATIONS</h2></center><br>
              <center>  <?php
			...
			while($m=mysql_fetch_array($q))
				{
					...
					echo "* The last date for your fine payment has been dued, you are asked to report to the $m[2] policestation.<br>";
					echo "* Appointment request for lawyer dated on $n[3] has been accepted.<br>";
					echo "* Your request to change data has been accepted.<br>";
								}
				}
				}
				if($a!=0)
				{
				while($o=mysql_fetch_array($t))
						{
							echo "* Appointment request for lawyer dated on $o[3] has been rejected.<br>";
							}
				}
				if($b!=0)
				{
								while($l=mysql_fetch_array($u))
								{
					
					
					echo "* Your request to cahnge data has been rejecte.<br>";
