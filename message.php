...
//echo $d;
$no1=$_REQUEST['no'];
$s=mysql_query("select ps_name from case_details where id='$d'");
...
if(isset($_POST['submit']))
{
	...
	$notif=$_POST['msg'];
	$m=mysql_query("select * from messages where case_id='$d'");
$n=mysql_num_rows($m);
if($n==0)
	{
	$q=mysql_query("insert into messages(msg,ps_name,case_id,veh_no)values('$notif','$name','$d','$no1')");
	...
	echo "<script>alert('Message already send')</script>";
}
?>
<!DOCTYPE html>
...
<div class="wrap-body">
    ...
    <nav class="cmn-tile-nav">
		<ul class="clearfix">
			...
			<li class="colour-5"><a href="index.php">Logout</a></li>
