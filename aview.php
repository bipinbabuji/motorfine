...
$s=mysql_query("select * from appointment where id='$reg1'");
?>
<!DOCTYPE html>
	...
	<div class="wrap-container zerogrid">
		...
		<div id="main-content">
			<div class="wrap-content">
				<center><h2>APPROVE/REJECT APPOINTMENTS</h2></center><br>
               
                <center><table style="border:1px solid rgba(0,0,0,1.00); align-content:center;width:800px">
                <tr style="border:1px solid rgba(0,0,0,1.00);"><th colspan="2" style="border:1px solid rgba(0,0,0,1.00);">DETAILS</th></tr>
                <?php
				...
				while($n=mysql_fetch_array($q))
				{
					...
					{
					echo "<tr style='border:1px solid rgba(0,0,0,1.00);' align='center'><td style='border:1px solid rgba(0,0,0,1.00);'>Name</td><td style='border:1px solid rgba(0,0,0,1.00);'>$n[0]</td></tr>
					<tr style='border:1px solid rgba(0,0,0,1.00);' align='center'><td style='border:1px solid rgba(0,0,0,1.00);'>Address</td><td style='border:1px solid rgba(0,0,0,1.00);'>$n[1]</td></tr>
					<tr style='border:1px solid rgba(0,0,0,1.00);' align='center'><td style='border:1px solid rgba(0,0,0,1.00);'>Phone</td><td style='border:1px solid rgba(0,0,0,1.00);'>$n[2]</td></tr>
					<tr style='border:1px solid rgba(0,0,0,1.00);' align='center'><td style='border:1px solid rgba(0,0,0,1.00);'>Email</td><td style='border:1px solid rgba(0,0,0,1.00);'>$n[3]</td></tr>
					
					<tr style='border:1px solid rgba(0,0,0,1.00);' align='center'><td style='border:1px solid rgba(0,0,0,1.00);'>Appointment date</td><td style='border:1px solid rgba(0,0,0,1.00);'>$m[3]</td></tr>
					<tr style='border:1px solid rgba(0,0,0,1.00);' align='center'><td style='border:1px solid rgba(0,0,0,1.00);'>Appointment time</td><td style='border:1px solid rgba(0,0,0,1.00);'>$m[4]</td></tr>
					
					<td colspan='2' style='border:1px solid rgba(0,0,0,1.00);' align='center'><a href='aapprove.php?id=$m[0]'>Approve</a>/<a href='arejectphp?id=$m[0]'>Reject</a></td></tr>";
				}
				}
				?>
                </table></center>
