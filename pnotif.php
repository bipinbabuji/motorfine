...
session_start();
$user1=$_SESSION['user'];
$r=mysql_query("select ps_name from policestation where uname='$user1'");
list($name)=mysql_fetch_row($r);
//echo $name;
$q=mysql_query("select * from messages where status='0' and ps_name='$name'");
...
<div class="wrap-body">
    ...
    <nav class="cmn-tile-nav">
		<ul class="clearfix">
			...
			<li class="colour-3"><a href="policehome.php">Home</a></li>
			<li class="colour-4"><a href="addcase.php">cases</a></li>
			<li class="colour-5"><a href="pnotif.php">Notifications</a></li>
			<li class="colour-6"><a href="index_1.php">Logout</a></li>
		...
		<div id="main-content">
            ...
            <br>
                ...
                <tr style="border:1px solid rgba(0,0,0,1.00);">
                    <th style="border:1px solid rgba(0,0,0,1.00);">MESSAGE</th>
                    <th style="border:1px solid rgba(0,0,0,1.00);">VEHICLE_NO</th>
                    <th style="border:1px solid rgba(0,0,0,1.00);">CASE_ID</th>
				...
				while($n=mysql_fetch_array($q))
				{
					echo "<tr style='border:1px solid rgba(0,0,0,1.00);' align='center'>"
                                    ...
                                    . "<a href='forward.php?id=$n[0]'>Forward</a></tr>";
				}
				}
				?>
                </table></center>
